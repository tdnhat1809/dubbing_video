        ...
        <section className="w-full md:w-[40%] bg-gradient-to-br from-[#1a1145] to-[#302950] flex flex-col justify-between p-12 relative overflow-hidden">
          ...
          <div className="z-10">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-black tracking-tighter text-white">DichTuDong.com</span>
            </div>
          </div>
          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="space-y-2">
                ...
                <input className="w-full px-6 py-4 bg-surface-container-low border-none rounded-xl focus:ring-2 focus:ring-primary/20 focus:bg-surface-container-lowest transition-all placeholder:text-outline-variant" id="reg-email" placeholder="ten@congty.com" type="email" value={email} onChange={(e) => setEmail(e.target.value)} />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-sm font-bold text-on-surface ml-1" htmlFor="reg-password">Mật khẩu</label>
                  <input className="w-full px-6 py-4 bg-surface-container-low border-none rounded-xl focus:ring-2 focus:ring-primary/20 focus:bg-surface-container-lowest transition-all placeholder:text-outline-variant" id="reg-password" placeholder="Tối thiểu 8 ký tự" type="password" value={password} onChange={(e) => setPassword(e.target.value)} />
                </div>
                <div className="space-y-2">
              ...
              <div className="flex items-start gap-3 pt-2">
                ...
                <label htmlFor="agree" className="text-sm text-on-surface-variant leading-relaxed">
                  Tôi đồng ý với <a className="text-primary font-semibold hover:underline" href="/thu-vien/dieu-khoan">Điều khoản sử dụng</a> và <a className="text-primary font-semibold hover:underline" href="#">Chính sách bảo mật</a> của DichTuDong.com
                </label>
              </div>

              <div className="pt-2">
                <button className="w-full bg-primary text-on-primary py-4 rounded-xl font-black text-lg shadow-xl shadow-primary/20 hover:shadow-primary/40 transition-all active:scale-[0.97] disabled:opacity-50 disabled:cursor-not-allowed" type="submit" disabled={!agreed}>
                  Tạo Tài Khoản
                </button>
              </div>
            </form>
