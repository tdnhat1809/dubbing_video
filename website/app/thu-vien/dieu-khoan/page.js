      ...
      <main className="max-w-4xl mx-auto px-8 pb-20">
        <div className="bg-surface-container-lowest rounded-3xl p-8 md:p-12 shadow-sm space-y-8">
          <section>
            ...
            <p className="text-on-surface-variant leading-relaxed">Chào mừng bạn đến với B2Vision.com. Bằng việc sử dụng dịch vụ của chúng tôi, bạn đồng ý tuân thủ các điều khoản và điều kiện được nêu trong tài liệu này. Vui lòng đọc kỹ trước khi sử dụng nền tảng.</p>
          </section>
          <section>
            <h2 className="text-2xl font-bold text-on-surface mb-4">2. Quyền sở hữu trí tuệ</h2>
            <p className="text-on-surface-variant leading-relaxed">Bạn giữ toàn bộ quyền sở hữu đối với nội dung gốc mà bạn tải lên. B2Vision.com không lưu trữ video sau khi xử lý hoàn tất. Bản quyền video dịch thuộc về chủ sở hữu video gốc.</p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="text-on-surface-variant leading-relaxed">B2Vision.com cung cấp dịch vụ dịch thuật tự động bằng AI. Mặc dù đạt độ chính xác lên đến 97,8%, chúng tôi không đảm bảo kết quả hoàn hảo 100% và khuyến khích người dùng kiểm tra bản dịch trước khi sử dụng chính thức.</p>
          </section>
          <section>
            <h2 className="text-2xl font-bold text-on-surface mb-4">6. Liên hệ</h2>
            <p className="text-on-surface-variant leading-relaxed">Mọi thắc mắc về điều khoản sử dụng, vui lòng liên hệ qua email: <span className="text-primary font-semibold">support@b2vision.com</span> hoặc hotline: <span className="text-primary font-semibold">1900-xxxx</span>.</p>
          </section>
        </div>
      </main>
    </>
