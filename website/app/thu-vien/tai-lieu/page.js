export default function TaiLieuPage() {
  const docs = [
    { title: 'Hướng dẫn sử dụng API DichTuDong', desc: 'Tài liệu chi tiết về cách tích hợp API dịch thuật video tự động vào ứng dụng của bạn.', icon: 'api', tag: 'API' },
    ...
    { title: 'Changelog & Cập nhật', desc: 'Theo dõi các bản cập nhật mới nhất của nền tảng DichTuDong.com.', icon: 'update', tag: 'Updates' },
      ...
      <header className="relative overflow-hidden pt-20 pb-32 px-6">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-on-surface-variant leading-relaxed max-w-3xl mx-auto">
            Tham khảo tài liệu kỹ thuật, hướng dẫn API và các tài nguyên phát triển để tích hợp DichTuDong vào dự án của bạn.
          </p>
        </div>
      </header>
